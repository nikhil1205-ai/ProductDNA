...
class ResourceManager:
    ...
    Integrates collectors, SHA-256 duplicate detection, local storage, and manifest management.
    """
    ...
    def add_resource(self, source_input: SourceInput) -> Source:
        ...
        performs SHA-256 duplicate check, saves files locally, and returns the registered Source.
        """
