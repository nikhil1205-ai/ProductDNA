...
# Storage destination: Backend/organization_sources/data_sources
STORAGE_DIR = Path(__file__).resolve().parent.parent.parent / "organization_sources" / "data_sources"
...
class ResourceStore:
    ...
    Manages physical file artifacts under organization_sources/data_sources/resources/<source_id>/
    and tracks resource records in organization_sources/data_sources/resource_manifest.json.
    """
